                ...
                <div class="col-md-9">
                    <div class="udb">
                        ...
                        <div class="udb-sec udb-prof">
                            <h4><img src="{{asset('/build/assets/images/icon/db1.png')}}" alt="" /> My Profile</h4>
                        ...
                        <div class="udb-sec udb-cour">
                            <h4><img src="{{asset('/build/assets/images/icon/db2.png')}}" alt="" /> Booking Courses</h4>
                            ...
                            <div class="sdb-cours">
                                <ul>
                                    <li>
                                        <a href="#">
                                            <div class="list-mig-like-com com-mar-bot-30">
                                                <div class="list-mig-lc-img"> <img src="{{asset('/build/assets/images/course/3.jpg')}}" alt=""> <span class="home-list-pop-rat list-mi-pr">Duration:150 Days</span> </div>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="list-mig-like-com com-mar-bot-30">
                                                <div class="list-mig-lc-img"> <img src="{{asset('/build/assets/images/course/4.jpg')}}" alt=""> <span class="home-list-pop-rat list-mi-pr">Duration:60 Days</span> </div>
                                                <div class="list-mig-lc-con">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="list-mig-like-com com-mar-bot-30">
                                                <div class="list-mig-lc-img"> <img src="{{asset('/build/assets/images/course/5.jpg')}}" alt=""> <span class="home-list-pop-rat list-mi-pr">Duration:30 Days</span> </div>
                                                <div class="list-mig-lc-con">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="list-mig-like-com com-mar-bot-30">
                                                <div class="list-mig-lc-img"> <img src="{{asset('/build/assets/images/course/3.jpg')}}" alt=""> <span class="home-list-pop-rat list-mi-pr">Duration:20 Days</span> </div>
                                                <div class="list-mig-lc-con">
                                                    <h5>Master of Science</h5>
                                                    <p>Illinois City,</p>
                                                </div>
                        ...
                        <div class="udb-sec udb-cour-stat">
                            <h4><img src="{{asset('/build/assets/images/icon/db3.png')}}" alt="" /> Course Status</h4>
                            <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text.The point of using Lorem Ipsummaking it look like readable English.</p>
                        ...
                        <div class="udb-sec udb-time">
                            <h4><img src="{{asset('/build/assets/images/icon/db4.png')}}" alt="" /> Class Time Line</h4>
